    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
            <form id="formdepartemen" class="form-horizontal" method="post" action="<?php echo base_url('datadepartemen/proses_tambah') ?>">
              <div class="box-body">
                          
                <div class="form-group">
                  <label class="col-lg-2 control-label">Department Name</label>
                  <div class="col-lg-5">
                  <input type="text" class="form-control" name="namadepartemen" placeholder="Department Name">
                  </div>
                </div>
