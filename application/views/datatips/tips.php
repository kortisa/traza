          ...
          <div class="box collapsed-box">
            ...
            <div class="box-body">
                <form id="form-filter" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="FirstName" class="col-sm-2 control-label">Article</label>
                        <div class="col-sm-4">
         ...
         <div class="box">
          <div class="box-body">
            <div class="box-header">
              <a href="<?php echo base_url('datatips/tambah')?>" class="btn btn-info" role="button" title="Add"><i class="fa fa-plus" aria-hidden="true">Add</i></a>
            </div>
...
$(document).ready(function() {
    ...
    table = $('#example1').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('datatips/ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
                data.id = $('#id').val();
