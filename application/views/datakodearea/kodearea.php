            ...
            <div class="box-body">
                <form id="form-filter" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="idjabatan">
                        </div>
                    </div>
                    <div class="form-group">
         ...
         <div class="box">
          <div class="box-body">
            <div class="box-header">
              <a href="<?php echo base_url('datakodearea/tambah')?>" class="btn btn-info" role="button" title="Add"><i class="fa fa-plus" aria-hidden="true">Add</i></a>
            </div>
...
$(document).ready(function() {
    ...
    table = $('#example1').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('datakodearea/ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
                //data.postid = $('#idjabatan').val();
