    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
            <form id="formjabatan" class="form-horizontal" method="post" action="<?php echo base_url('datajabatan/proses_ubah') ?>">
              <div class="box-body">

                <div class="form-group hide">
                  <label class="col-lg-2 control-label">Id</label>
                  <div class="col-lg-5">
                  <input type="text" class="form-control" name="idjabatan" placeholder="Position Id" value="<?php echo $jabatan->postid ?>" readonly>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                  <input type="text" class="form-control" name="namajabatan" placeholder="Position Name" value="<?php echo $jabatan->postname ?>">
                  </div>
                </div>              
              </div>
