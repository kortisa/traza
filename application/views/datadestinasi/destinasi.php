            ...
            <div class="box-body">
                <form id="form-filter" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                        <select class="form-control" id="areakode">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                        <input type="number" class="form-control" id="konstanta" placeholder="Constant" min="0"  step="0.1" data-stepper-options='{"labels":{"up":"Increase","down":"Decrease"}}'>
                        </div>
                      </div>
                    <div class="form-group">
         ...
         <div class="box">
          <div class="box-body">
            <div class="box-header">
              <a href="<?php echo base_url('datadestinasi/tambah')?>" class="btn btn-info" role="button" title="Add"><i class="fa fa-plus" aria-hidden="true">Add</i></a>
            </div>
...
$(document).ready(function() {
    ...
    table = $('#example1').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('datadestinasi/ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
                data.name_destination = $('#name_destination').val();
                data.name = $('#areakode').val();
                data.currency = $('#currency').val();
                data.constant = $('#konstanta').val();
            }
        },
