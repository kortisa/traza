...
<html lang="en">
	...
	<body>
		...
		<a href="<?php echo base_url('telegramnotif/submissionprocessed/247653891'); ?>"><button id="btnfun1" name="btnfun1">Submission Processed</button></a><br><br>
...
$chatid = "247653891";*/
 ...
 if(1==1)
 	{
 		//_submissionprocessed($chatid);
 		base_url("telegramnotif/_submissionprocessed/");
 	}
