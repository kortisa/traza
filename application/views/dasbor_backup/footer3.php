  ...
  $(document).ready(function(){
    $("#approval").click(function(){
        ...
        if(vname=='' && vpesan==''){
            ...
            $.post("<?=base_url()?>notifikasi/approval", //url untuk menangani insert data ke database
            {
...
$(function () {
    $("#clickme").click(function () {
        ...
        var vname = $("#klik").val();
            ...
            $.post("<?=base_url()?>notifikasi/deletenotif", //url untuk menangani insert data ke database
            {
                // Data variabel yang dikirim ke server
                nama:vname
            });
