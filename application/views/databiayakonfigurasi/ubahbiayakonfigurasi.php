    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
            <form role="form" id="updatebasirate" method="post" class="form-horizontal" action="<?php echo base_url('databiayakonfigurasi/proses_ubah_basicrate') ?>">
              <div class="box-body">
                <?php 
                ...
                <div class="form-group">
                  ...
                  <option value="<?php echo $basic->receipt ?>"><?php echo ucfirst($basic->receipt) ?></option>
...
$(document).ready(function() {
    var nospecial=/^[^*|\":<>[\]{}`\\()';@&$#!]+$/;
    $('#updatebasirate').bootstrapValidator({
            ...
            name: {
                validators: {
                    ...
                    stringLength: {
                        min: 2,
                        max: 15,  
                        message: 'Name must be more than 2 and less than 15 characters long'
                    },
                    regexp: {
                        regexp: nospecial,
            ...
            frequency: {
                validators: {
                    ...
                    stringLength: {
                        min: 1,
                        max: 20,
                        message: 'Frequency must be more than 1 and less than 20 characters long'
                    }
                }
            },
