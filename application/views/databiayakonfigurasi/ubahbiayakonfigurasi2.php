    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
            <form role="form" id="updatepocket" method="post" class="form-horizontal" action="<?php echo base_url('databiayakonfigurasi/proses_ubah_basicratepocket') ?>">
              <div class="box-body">
                <?php 
...
$(document).ready(function() {
    var nospecial=/^[^*|\":<>[\]{}`\\()';@&$#!]+$/;
    $('#updatepocket').bootstrapValidator({
