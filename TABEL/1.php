...
<head>
  ...
  <link rel="stylesheet" href="dist/css/progress-wizard.min.css">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Citra tubindo</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu">
        <li class="header">MAIN NAVIGATION</li>
          ...
          <ul class="treeview-menu">
            <li><a href="../../index.html"><i class="fa fa-level-up"></i> Level</a></li>
            <li><a href="../../index2.html"><i class="fa fa-group"></i> Employee</a></li>
            <li><a href="../../index.html"><i class="fa fa"></i> Currency</a></li>
            <li><a href="../../index2.html"><i class="fa fa-binoculars"></i>Location</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../../index.html"><i class="fa fa-plus"></i> Cost Configuration</a></li>
            <li><a href="../../index2.html"><i class="fa fa-binoculars"></i> Approval</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-plane"></i> <span>Realisasi Perjalanan </span>
             <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
...
<section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Laporan Perjalanan Dinas
    ...
    <tr height="50">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
    <br></br>
                     <h5 style="margin-top: 10px;">Batam    31.Maret.20117</h5> 
                     <h5 style="margin-top: 10px;">Disiapkan oleh,</h5>  <br>
        ...
        <div class="col-xs-3">
                     ...
                     <h5 style="margin-top: 10px;">Diketahui oleh,</h5>  <br>
                     <h5 style="margin-top: 10px;">
                     <br><br>
                     <b><u>LD</u></b>
                     </h5>
          ...
          <div class="col-xs-3">
                     ...
                     <h5 style="margin-top: 10px;">Verifikasi oleh,</h5>  <br>
                     <h5 style="margin-top: 10px;">
                     <br><br>
                     <b><u>YW</u></b>
                     </h5>
